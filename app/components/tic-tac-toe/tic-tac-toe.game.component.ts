...
export class TicTacToeGameComponent implements OnInit {
    ...
    startTheGame(): void {
        ...
        // event binding
        this.ticTacToeSrvc.messageReceived.subscribe(() => this.messageReceived());
        this.ticTacToeSrvc.changeActivePlayer.subscribe(() => this.changeActivePlayer());
        this.ticTacToeSrvc.swapMarkers.subscribe(() => this.swapMarkers());
